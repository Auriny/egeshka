...
print("19)", [s for s in range(21) if f(s, 3)])
print("20)", [s for s in range(21) if f(s, 2) or f(s, 4)])
print("21)", [s for s in range(21) if (f(s, 1) or f(s, 3) or f(s, 5)) and not f(s, 1) and not (f(s, 1) or f(s, 3))])
